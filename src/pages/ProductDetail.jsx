...
const s = {
    ...
    title: { fontFamily: "'Outfit', sans-serif", fontSize: '2.5rem', fontWeight: 700, lineHeight: 1.1, marginBottom: '1rem' },
    ...
    price: { fontFamily: "'Outfit', sans-serif", fontSize: '2.2rem', fontWeight: 700 },
    ...
    totalValue: { fontFamily: "'Outfit', sans-serif", fontSize: '1.5rem', fontWeight: 700 },
