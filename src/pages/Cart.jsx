...
const s = {
    ...
    itemInfo: { flex: 1 },
    itemName: { fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: '1rem', marginBottom: '0.3rem' },
    ...
    itemTotal: { fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: '1.1rem', minWidth: '90px', textAlign: 'right' },
    ...
    summaryTitle: { fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: '1.3rem', marginBottom: '1.5rem' },
    ...
    summaryTotal: { display: 'flex', justifyContent: 'space-between', fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: '1.3rem', marginBottom: '1.5rem' },
    ...
    successTitle: { fontFamily: "'Syne', sans-serif", fontSize: '2rem', fontWeight: 800, marginBottom: '0.5rem' },
