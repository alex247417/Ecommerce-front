...
const s = {
    ...
    title: { fontFamily: "'Syne', sans-serif", fontSize: '2.5rem', fontWeight: 800, marginBottom: '2rem' },
    ...
    orderId: { fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: '1.1rem' },
    ...
    total: { fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: '1.2rem', marginTop: '0.4rem' },
